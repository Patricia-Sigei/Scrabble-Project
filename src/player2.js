document.addEventListener("DOMContentLoaded", function () {
    const player2Container = document.getElementById("player2"); // Change container to player2
    ...
    function wordRack(container) {
        ...
        const predefinedLetters = ['C','A', 'T', 'F','D', 'A', 'R', 'E']; // Change the word to DARE
    ...
    function animateToBoard() {
        const letters = ['D', 'A', 'R', 'E']; // Change the word to DARE
        console.log("Starting animation to board...");

        letters.forEach((letter, index) => {
            const rackTile = document.querySelector(`#player2 #rack-${letter}`); // Change selector to player2
            const boardTile = document.getElementById(`player2-${startRow},${startCol + index}`); // Change prefix to player2
    ...
    genBoard(player2Container, "player2"); // Change container to player2 and prefix to player2
    wordRack(player2Container); // Change container to player2
    animateToBoard(); // Start animation for DARE
});
